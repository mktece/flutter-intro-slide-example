  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        ...
        description:
        "This is the description example here goes your description ,please add description as your need",
    ...
    slides.add(
      new Slide(
        ...
        styleDescription: TextStyle(
            ...
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "images/photo_school_1.png",
      ),
    );
    slides.add(
      new Slide(
        ...
        styleDescription: TextStyle(
            ...
            fontStyle: FontStyle.italic,
            fontFamily: 'Raleway'),
        pathImage: "images/photo_school_2.png",
      ),
    );
  }
